    ...
    return (
        <div className="flex flex-col items-center justify-center h-full min-h-[400px]">
            <div className="saas-card p-12 bg-white text-center max-w-md flex flex-col items-center">
                ...
                <h1 className="text-xl font-bold text-neutral-900 mb-2">RBAC Control Center</h1>
                <p className="text-sm text-neutral-500 mb-8">Role-Based Access Control (RBAC) management is restricted to Super Administrators. Security layer loading...</p>
